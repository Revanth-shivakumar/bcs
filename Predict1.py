# -*- coding: utf-8 -*-
"""Copy of Copy of custom_model.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1-ilfLidSJCLYM5b-hOUe_pqw8Ic0ON5a
"""
...
class net(ImageClassificationBase):
    ...
    def forward(self, xb):
        ...
        return out
model=to_device(net(3,3),device)

model.load_state_dict(torch.load(sys.args[3]))
...
img_t=tr(img_t)
print('Label:', classes[label], ', Predicted:', predict_image(img_t, model))
